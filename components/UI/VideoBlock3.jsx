...
export default function VideoBlock3() {
  ...
  return (
    <div className='relative w-[270px] h-[590px] flex flex-col items-center justify-center overflow-hidden rounded-[30px] bg-[url(/img/VideoBlock-3/video_3-1_prev.png)] bg-cover group mt-12 xl:mt-0 xl:mr-12 border border-solid'>
      {hasWindow && 
        <ReactPlayer
