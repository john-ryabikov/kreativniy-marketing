...
export default function FooterLinks() {
  return (
    <div className='relative w-full flex flex-col xl:flex-row items-center justify-start xl:justify-between'>
        <p className='relative text-center xl:text-left font-extralight text-[#848484] text-base mb-8 xl:mb-0'>ИНН 503124024765<br/>ОГРНИП 325508100452210<br/>ИП ТИМОШИНА ИРИНА АЛЕКСАНДРОВНА</p>
